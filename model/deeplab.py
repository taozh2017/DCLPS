...
class ResNet101(nn.Module):
    ...
    def forward(self, x, require_embedding_feature=False):
        ...
        x = self.layer4(x)  # embedding feature
        out = self.layer5(x)  # decoder
...
def Deeplab(num_classes=21, init_weights=None, restore_from=None, phase='train'):
    ...
    if restore_from is not None: 
        ...
        if init_weights is not None:
            print('load pretrained model, ', init_weights)
        ...
        # model.layer5 = model._make_pred_layer(Classifier_Module, 2048, [6, 12, 18, 24], [6, 12, 18, 24], num_classes)
    return model
